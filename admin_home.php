 		...
 		<div class="col-12 admin_common-frame" id="home" style="display: block;">
 			...
 			<div class="col-12 admin_top_contents">
 				<div class="col-3 admin_total_revenue">
 					...
 					<div class="col-6 admin_total_revenue_content">
 						<h1>$<span class="value" name="23567">0</span></h1>
 						<p>Total Revenue</p>
 					</div>
 				</div>
 				<div class="col-3 admin_total_revenue">
 					...
 					<div class="col-6 admin_total_revenue_content">
 						<h1>$<span class="value" name="127">0</span></h1>
 						<p>Today's Revenue</p>
 					</div>
 				</div>
 				<div class="col-3 admin_total_revenue">
 					...
 					<div class="col-6 admin_total_revenue_content">
 						<h1><span class="value" name="0.62">0</span>%</h1>
 						<p>New Employees</p>
 					</div>
 				</div>
 				<div class="col-3 admin_total_revenue">
 					...
 					<div class="col-6 admin_total_revenue_content">
 						<h1><span class="value" name="78.35">0</span>k</h1>
 						<p>Today's Visits</p>
 					</div>
 				</div>
 			</div>
 			<div class="col-12 admin_graphical">
 				<div class="col-4 admin_revenue_graph">
 					...
 					<div class="col-4 admin_target">
 						<p>Target</p>
 						<h2><span class="red">&#x2193;</span><span class="value" name="17.87">0</span>k</h2>
 					</div>
 					<div class="col-4 admin_lastweek">
 						<p>Last Week</p>
 						<h2><span class="gren">&#x2191;</span><span class="value" name="16.98">0</span>k</h2>
 						</h2>
 					</div>
 					<div class="col-4 admin_lastmonth">
 						<p>Last Month</p>
 						<h2><span class="red">&#x2193;</span><span class="value" name="32.14">0</span>k</h2>
 						</h2>
 					</div>
 				</div>
 			...
 			<div class="col-12">
 				<div class="col-3 admin_chat">
 					...
 					<div class="col-12 chat1">
 						...
 						<div class="col-10">
 							<p>Manifac</p>
 							<h6>wyncmmsgs ivebsysinceyes</h6>
 						</div>
 					</div>
 					<div class="col-12 chat1">
 								...
 								<?php
									...
									?>
 									<tr>
 										...
 										<td><?php echo $p_quandity; ?></td>
 										<td><?php echo $p_sort; ?></td>
 										<td style="background-color:#F1F9F9;"><a href="productExtraColorForm.php?product_id=<?php echo $p_id; ?>" style="color: black;">extra color</a></td>
 										<td style="background-color:#F1F9F9;"><a href="productExtraColorForm.php?product_id=<?php echo $p_id; ?>" style="color: black;">edit</a></td>
 									</tr>
 							<?php
									}
								}
